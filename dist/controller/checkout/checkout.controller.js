...
var CheckoutController = (function () {
    ...
    CheckoutController.prototype.addCartToCheckout = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var cartId, cart, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        cartId = req.body.cartId;
                        return [4, checkout_1.checkoutService.findCartByParams(req.user, cartId)];
                    case 1:
                        cart = _a.sent();
                        if (!cart) {
                        ...
                        return [4, checkout_1.checkoutService.createCheckout({
                                cart: cart._id,
                    ...
                    case 2:
                        _a.sent();
                        cart.status = constants_1.CartStatusEnum.SOLD;
                        return [4, services_1.cartService.updateCart(cart._id, cart)];
                    case 3:
                        _a.sent();
