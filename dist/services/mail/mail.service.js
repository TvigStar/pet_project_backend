...
var MailService = (function () {
    ...
    MailService.prototype.sendEmail = function (email, action, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        templateInfo = email_templates_1.htmlTemplates[action];
                        if (!templateInfo) {
                        ...
                        return [4, emailTemplate.render(templateInfo.templateFileName, context)];
                    case 1:
                        html = _a.sent();
                        return [4, transporter.sendMail({
                                from: "NOREPLY <".concat(config_1.config.ROOT_EMAIL, ">"),
                                to: email,
