...
exports.config = {
    ...
    MONGODB_URL: process.env.MONGODB_URL || 'mongodb+srv://admin:admin@cluster0.dbqelii.mongodb.net/?retryWrites=true&w=majority',
    ROOT_EMAIL: process.env.ROOT_EMAIL || 'yazmin.hintz45@ethereal.email',
    ROOT_EMAIL_PASSWORD: process.env.ROOT_EMAIL_PASSWORD || 'De6pdcyPpMRjPkFAdw',
